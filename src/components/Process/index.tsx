        ...
        <div className="row">
          <div className="col-lg-5">
            <div className="round-head mb-80">
              <h6 className="ls2 text-u fz-13 fw-600 mb-20 gr-green-text rest">Our Approach</h6>
              <h3 className={services ? 'fw-600':'fw-700'}>Embark on the <br /> innovation journey</h3>
            </div>
