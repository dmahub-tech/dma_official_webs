...
const Testimonials = ({ curve }: {curve: boolean}) => {
  ...
  return (
    <section className="testimonials slider-thumbs section-padding pb-0 bg-img parallaxie" data-background={curve ? "img/background/d4.jpg":"img/background/d4.jpg"} data-overlay-dark="6">
